class AvailableSymbolModel {
  EchoReq? echoReq;
  String? msgType;
  Subscription? subscription;
  Tick? tick;

  AvailableSymbolModel({this.echoReq, this.msgType, this.subscription, this.tick});

  AvailableSymbolModel.fromJson(Map<String, dynamic> json) {
